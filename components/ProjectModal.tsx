      ...
      {project && (
        ...
        >
          ...
          <motion.button
            ...
            aria-label="Close"
            className="group fixed right-5 top-5 z-[120] flex h-14 w-14 items-center justify-center rounded-full bg-accent text-on-accent shadow-[0_8px_30px_rgba(224,254,16,0.35)] transition-transform hover:scale-110 sm:right-8 sm:top-8 sm:h-16 sm:w-16"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
          ...
          >
            {/* Header */}
            <div className="border-b border-fg/10 pb-8">
            ...
            <div className="mt-10 flex flex-col gap-6 sm:gap-8">
              {project.thumbnails.map((src, i) => (
                <motion.div
                  ...
                  className="relative w-full overflow-hidden rounded-2xl border border-fg/10 bg-bg-soft"
                >
                  <Image
                    src={src}
            ...
            {/* Footer */}
            <div className="mt-16 flex flex-col items-start gap-6 border-t border-fg/10 pt-10 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                onClick={onClose}
                data-cursor="hover"
                className="inline-flex items-center gap-2 rounded-full border border-fg/15 bg-fg/5 px-6 py-3 font-mono text-xs uppercase tracking-[0.2em] text-fg transition-colors hover:bg-accent hover:text-on-accent"
              >
                ← Back to work
              </button>
            </div>
